...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        import app.models.founder_workspace  # noqa
...
from app.api.founder_workspaces import router as founder_workspaces_router
...
app.include_router(founder_workspaces_router, prefix=settings.API_PREFIX)
